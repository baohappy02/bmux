...
struct BmuxWorkspaceDefinition: Codable, Sendable {
    var name: String?
    var cwd: String?
    var color: String?
    var layout: BmuxLayoutNode?

    init(name: String? = nil, cwd: String? = nil, color: String? = nil, layout: BmuxLayoutNode? = nil) {
        self.name = name
        self.cwd = cwd
        self.color = color
        self.layout = layout
...
indirect enum BmuxLayoutNode: Codable, Sendable {
...
struct BmuxSplitDefinition: Codable, Sendable {
...
struct BmuxPaneDefinition: Codable, Sendable {
...
struct BmuxSurfaceDefinition: Codable, Sendable {
...
final class BmuxConfigStore: ObservableObject {
    ...
    private func updateLocalConfigPath(_ directory: String?) {
        ...
        if let directory, !directory.isEmpty {
            newPath = findBmuxConfig(startingFrom: directory)
                ?? (directory as NSString).appendingPathComponent("bmux.json")
        } else {
            newPath = nil
        }
    ...
    private func findBmuxConfig(startingFrom directory: String) -> String? {
        ...
        while true {
            let candidate = (current as NSString).appendingPathComponent("bmux.json")
    ...
    private func parseConfig(at path: String) -> BmuxConfigFile? {
