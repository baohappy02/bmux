...
private extension View {
    func bmuxFlatSymbolColorRendering() -> some View {
...
struct BrowserPanelView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .webViewDidReceiveClick).filter { [weak panel] note in
            ...
            guard let webView = note.object as? BmuxWebView else { return false }
...
struct WebViewRepresentable: NSViewRepresentable {
        ...
        private func updateHostedInspectorDockControlAvailabilityIfNeeded(reason: String) {
            ...
            hostedInspectorFrontendWebView.evaluateJavaScript(
                ...
                (() => {
                    ...
                    if (!WI.__bmuxOriginalUpdateDockNavigationItems && typeof WI._updateDockNavigationItems === "function")
                        WI.__bmuxOriginalUpdateDockNavigationItems = WI._updateDockNavigationItems;
                    if (!WI.__bmuxOriginalDockLeft && typeof WI._dockLeft === "function")
                        WI.__bmuxOriginalDockLeft = WI._dockLeft;
                    if (!WI.__bmuxOriginalDockRight && typeof WI._dockRight === "function")
                        WI.__bmuxOriginalDockRight = WI._dockRight;
                    if (!WI.__bmuxOriginalTogglePreviousDockConfiguration && typeof WI._togglePreviousDockConfiguration === "function")
                        WI.__bmuxOriginalTogglePreviousDockConfiguration = WI._togglePreviousDockConfiguration;
    ...
    private func updateUsingLocalInlineHosting(_ nsView: NSView, context: Context, webView: WKWebView) -> Bool {
        ...
        host.setHostedInspectorFrontendWebView(webView.bmuxInspectorFrontendWebView())
