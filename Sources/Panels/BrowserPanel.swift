...
final class BrowserPanel: Panel, ObservableObject {
    ...
    func switchToProfile(_ requestedProfileID: UUID) -> Bool {
        ...
        if let previousBmuxWebView = previousWebView as? BmuxWebView {
            previousBmuxWebView.onContextMenuDownloadStateChanged = nil
        }
    ...
    private func replaceWebViewPreservingState(
        ...
        if let oldBmuxWebView = oldWebView as? BmuxWebView {
            oldBmuxWebView.onContextMenuDownloadStateChanged = nil
        }
...
extension BrowserPanel {
    ...
    private func prepareDeveloperToolsForRevealIfNeeded(_ inspector: NSObject) {
        ...
        inspector.bmuxCallVoid(selector: attachSelector)
    }
    ...
    func restoreDeveloperToolsAfterAttachIfNeeded() {
        ...
        bmuxWithWindowFirstResponderBypass {
            _ = revealDeveloperTools(inspector)
        }
        setPreferredDeveloperToolsVisible(true)
