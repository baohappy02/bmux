...
struct SocketControlSettings {
    ...
    static let baseDebugBundleIdentifier = "com.bmuxterm.app.debug"
    private static let socketDirectoryName = "bmux"
    private static let stableSocketFileName = "bmux.sock"
    private static let lastSocketPathFileName = "last-socket-path"
    static let legacyStableDefaultSocketPath = "/tmp/bmux.sock"
    static let legacyLastSocketPathFile = "/tmp/bmux-last-socket-path"
    ...
    static func taggedDebugSocketPath(
        ...
        return "/tmp/bmux-debug-\(tag).sock"
    }
