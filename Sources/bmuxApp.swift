...
struct bmuxApp: App {
    ...
    @StateObject private var bmuxConfigStore = BmuxConfigStore()
            ...
            ContentView(updateViewModel: appDelegate.updateViewModel, windowId: primaryWindowId)
                ...
                .onAppear {
                    ...
                    if ProcessInfo.processInfo.environment["CMUX_UI_TEST_MODE"] == "1" {
                        UpdateLogStore.shared.append("ui test: bmuxApp onAppear")
                    }
#endif
...
private let bmuxAuxiliaryWindowIdentifiers: Set<String> = [
    ...
    "bmux.licenses",
    "bmux.browser-popup",
    "bmux.settingsAboutTitlebarDebug",
...
private final class SettingsAboutTitlebarDebugWindowController: NSWindowController, NSWindowDelegate {
    ...
    private init() {
        ...
        window.identifier = NSUserInterfaceItemIdentifier("bmux.settingsAboutTitlebarDebug")
        window.center()
...
final class SettingsWindowController: NSWindowController, NSWindowDelegate {
    ...
    private init() {
        ...
        window.isReleasedWhenClosed = false
        window.identifier = NSUserInterfaceItemIdentifier("bmux.settings")
        window.center()
...
enum WelcomeSettings {
    static let shownKey = "bmuxWelcomeShown"
}
...
struct SettingsView: View {
    ...
    @AppStorage("bmuxPortBase") private var bmuxPortBase = 9100
    @AppStorage("bmuxPortRange") private var bmuxPortRange = 10
    ...
    @AppStorage(BrowserLinkOpenSettings.openTerminalLinksInBmuxBrowserKey) private var openTerminalLinksInBmuxBrowser = BrowserLinkOpenSettings.defaultOpenTerminalLinksInBmuxBrowser
    @AppStorage(BrowserLinkOpenSettings.interceptTerminalOpenCommandInBmuxBrowserKey)
    private var interceptTerminalOpenCommandInBmuxBrowser = BrowserLinkOpenSettings.initialInterceptTerminalOpenCommandInBmuxBrowserValue()
    ...
    @AppStorage(BrowserLinkOpenSettings.openSidebarPullRequestLinksInBmuxBrowserKey)
    private var openSidebarPullRequestLinksInBmuxBrowser = BrowserLinkOpenSettings.defaultOpenSidebarPullRequestLinksInBmuxBrowser
    @AppStorage(BrowserLinkOpenSettings.openSidebarPortLinksInBmuxBrowserKey)
    private var openSidebarPortLinksInBmuxBrowser = BrowserLinkOpenSettings.defaultOpenSidebarPortLinksInBmuxBrowser
    ...
    @State private var trustedDirectoriesDraft: String = BmuxDirectoryTrust.shared.allTrustedPaths.joined(separator: "\n")
    ...
    private var paneFirstClickFocusSubtitle: String {
        if paneFirstClickFocusEnabled {
            return String(
                ...
                defaultValue: "When bmux is inactive, clicking a pane activates the window and focuses that pane in one click."
            )
        }
        return String(
            localized: "settings.app.paneFirstClickFocus.subtitleOff",
            defaultValue: "When bmux is inactive, the first click only activates the window. Click again to focus the pane."
        )
    }
    ...
    private func saveTrustedDirectories() {
        let paths = trustedDirectoriesDraft
            ...
            .filter { !$0.isEmpty }
        BmuxDirectoryTrust.shared.replaceAll(with: paths)
    }
                ...
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    SettingsCard {
                        ...
                        SettingsCardRow(
                            ...
                            subtitle: openSidebarPullRequestLinksInBmuxBrowser
                            ...
                            Toggle("", isOn: $openSidebarPullRequestLinksInBmuxBrowser)
                                .labelsHidden()
                                .controlSize(.small)
                        }
                        .disabled(sidebarHideAllDetails)
                        ...
                        SettingsCardRow(
                            ...
                            subtitle: openSidebarPortLinksInBmuxBrowser
                            ...
                            Toggle("", isOn: $openSidebarPortLinksInBmuxBrowser)
                                .labelsHidden()
                                .controlSize(.small)
                        }
                        .disabled(sidebarHideAllDetails)
                    ...
                    SettingsCard {
                        SettingsCardRow(String(localized: "settings.automation.portBase", defaultValue: "Port Base"), subtitle: String(localized: "settings.automation.portBase.subtitle", defaultValue: "Starting port for CMUX_PORT env var."), controlWidth: pickerColumnWidth) {
                            TextField("", value: $bmuxPortBase, format: .number)
                                .textFieldStyle(.roundedBorder)
                                .multilineTextAlignment(.trailing)
                        }
                        ...
                        SettingsCardRow(String(localized: "settings.automation.portRange", defaultValue: "Port Range Size"), subtitle: String(localized: "settings.automation.portRange.subtitle", defaultValue: "Number of ports per workspace."), controlWidth: pickerColumnWidth) {
                            TextField("", value: $bmuxPortRange, format: .number)
                                .textFieldStyle(.roundedBorder)
                                .multilineTextAlignment(.trailing)
                        }
                    ...
                    SettingsCard {
                        VStack(alignment: .leading, spacing: 6) {
                            SettingsCardRow(
                                ...
                                subtitle: String(localized: "settings.customCommands.trustedDirectories.subtitle", defaultValue: "Commands from bmux.json in these directories run without confirmation. One path per line.")
                            ) {
                                EmptyView()
                            }
                        ...
                        SettingsCardDivider()
                        SettingsCardNote(String(localized: "settings.customCommands.trustedDirectories.note", defaultValue: "Place a bmux.json in your project root to define custom commands. Trust a directory from the confirmation dialog, or add paths here. For git repos, trusting the root covers all subdirectories."))
                    }
                    ...
                    SettingsCard {
                        ...
                        SettingsCardRow(
                            ...
                            Toggle("", isOn: $openTerminalLinksInBmuxBrowser)
                                .labelsHidden()
                                .controlSize(.small)
                        }
                        ...
                        SettingsCardRow(
                            ...
                            Toggle("", isOn: $interceptTerminalOpenCommandInBmuxBrowser)
                                .labelsHidden()
                                .controlSize(.small)
                        }

                        if openTerminalLinksInBmuxBrowser || interceptTerminalOpenCommandInBmuxBrowser {
                            SettingsCardDivider()
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Text(String(localized: "settings.browser.httpAllowlist.description", defaultValue: "Controls which HTTP (non-HTTPS) hosts can open in bmux without a warning prompt. Defaults include localhost, 127.0.0.1, ::1, 0.0.0.0, and *.localtest.me."))
                                .font(.caption)
                                .foregroundStyle(.secondary)
    ...
    private func resetAllSettings() {
        ...
        openSidebarPullRequestLinksInBmuxBrowser = BrowserLinkOpenSettings.defaultOpenSidebarPullRequestLinksInBmuxBrowser
        openSidebarPortLinksInBmuxBrowser = BrowserLinkOpenSettings.defaultOpenSidebarPortLinksInBmuxBrowser
...
private struct SettingsRootView: View {
    ...
    private func configureSettingsWindow(_ window: NSWindow) {
        ...
        for index in accessories.indices.reversed() {
            ...
            guard identifier.hasPrefix("bmux.") else { continue }
