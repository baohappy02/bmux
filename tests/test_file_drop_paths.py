...
def wait_for_text(client: bmux, surface_id: str, needle: str, timeout: float = 3.0) -> bool:
...
def main() -> int:
    ...
    p1 = (tmp / "bmux drop [image] #1 (a).png").resolve()
    p2 = (tmp / "bmux drop second & file!.jpg").resolve()
