#!/usr/bin/env python3
"""
Regression test: `bmux claude-teams --help` passes through to Claude.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="bmux-claude-teams-help-") as td:
        tmp = Path(td)
        home = tmp / "home"
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `bmux claude-teams --help` exited non-zero")
    ...
    print("PASS: bmux claude-teams forwards --help to Claude")
    return 0
