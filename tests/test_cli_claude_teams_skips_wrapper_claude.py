#!/usr/bin/env python3
"""
Regression test: `bmux claude-teams` skips bmux wrapper scripts on PATH.
"""
...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="bmux-claude-teams-wrapper-") as td:
        tmp = Path(td)
...
""",
        ...
        if proc.returncode != 0:
            print("FAIL: `bmux claude-teams --version` executed a wrapper instead of the real claude binary")
    ...
    print("PASS: bmux claude-teams skips bmux wrapper scripts on PATH")
    return 0
